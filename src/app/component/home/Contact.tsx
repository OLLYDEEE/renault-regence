...
const Contact = () => {
  return (
    <div className="mt-20 bg-[#222] min-h-[350px] mb-8">
      <div className="max-w-[540px] lg:max-w-[1220px] mx-auto px-[10px] py-10 ">
        <div className="flex w-fit mx-auto gap-20 items-center">
          ...
          <div className="flex flex-col text-center lg:text-start">
            <div className="flex justify-start ">
              <h1 className="uppercase text-center lg:text-start w-full text-white font-bold">lojas</h1>
            </div>
