...
const Offer = () => {
  return (
    <div className="md:mx-[64px] mx-2 mt-10 cursor-pointer">
     ...
     <div className="mt-10 flex">
        <div className="h-auto w-[150px] md:w-[280px] pb-10">
          <div className="w-full h-full rounded-md flex flex-col items-center md:px-2 border">
            ...
            <div className="mt-4 py-4">
              <Image src={car1} alt="car1" className=" w-[108px] md:w-auto object-contain hover:scale-110 duration-300"/>
            </div>
           <p className="uppercase max-w-[118px] text-[16px] mt-4 font-bold text-center">KWID ZEN 2024 É NA REGENCE É 1º Lugar no Google, os clientes mais felizes!</p>
         <div className="mt-8 border-t w-full border-[#FFC107]"></div>
         <p className="text-[12.8px] max-w-[138px] md:mx-w-auto text-[#222222] py-[10px] mt-8 text-center">SÓ A CONCESSIONÁRIA RENAULT REGENCE COM O MELHOR ATENDIMENTO DO BRASIL GARANTE O MELHOR NEGÓCIO! COBRIMOS QUALQUER OFERTA DA CONCORRÊNCIA.
OFERTA ESPECIAL:
...
pr-[10px] flex justify-center items-center pl-[7px] py-4 mb-2">MAIS DETALHES</button>
      ...
      <div className="mt-10 flex">
        <div className="h-auto w-[150px] md:w-[280px] ">
          <div className="w-full h-full rounded-md flex flex-col items-center px-2 border">
            <div className="bg-[#DC3545]  md:px-2 py-[2px] flex mt-4 rounded-xl items-center gap-1  text-white justify-center">
              <FaRegClock className="font-light" />
              <p className="font-semibold text-[12px]">Expira em 18 DIAS</p>
            </div>
            <div className="mt-4 py-4">
              <Image src={car2} alt="car1" className="w-[108px] md:w-auto object-contain hover:scale-110 duration-300"/>
            </div>
           <p className="uppercase max-w-[118px]  md:mx-w-auto text-[1rem] mt-4 font-bold text-center w-[208px]">
      ...
      <div className="mt-10 flex">
        <div className="h-auto w-[150px] md:w-[280px] ">
          <div className="w-full h-full rounded-md flex flex-col items-center md:px-2 border">
            ...
            <div className="mt-4 py-4">
              <Image src={car3} alt="car1" className="w-[108px] md:w-auto object-contain hover:scale-110 duration-300"/>
            </div>
           <p className="uppercase max-w-[118px]  md:mx-w-auto  text-[1rem] mt-4 font-bold text-center w-[208px]">
      ...
      <div className="mt-10 flex">
        <div className="h-auto w-[150px] md:w-[280px] ">
          <div className="w-full h-full rounded-md flex flex-col items-center px-2 border">
            ...
            <div className="mt-4 py-4">
              <Image src={car4} alt="car1" className="w-[108px] md:w-auto object-contain hover:scale-110 duration-300"/>
            </div>
           <p className="uppercase max-w-[118px]  md:mx-w-auto text-[1rem] mt-4 font-bold text-center w-[208px]">
      ...
      <div className="mt-10 flex">
        <div className="h-auto w-[150px] md:w-[280px] ">
          <div className="w-full h-full rounded-md flex flex-col items-center px-2 border">
            ...
            <div className="mt-4 py-4">
              <Image src={car5} alt="car1" className="w-[108px] md:w-auto object-contain hover:scale-110 duration-300"/>
            </div>
           <p className="uppercase max-w-[118px]  md:mx-w-auto text-[1rem] mt-4 font-bold text-center w-[208px]">
      ...
      <div className="mt-10 flex">
        <div className="h-auto w-[150px] md:w-[280px] ">
          <div className="w-full h-full rounded-md flex flex-col items-center px-2 border">
            ...
            <div className="mt-4 py-4">
              <Image src={car6} alt="car1" className="w-[108px] md:w-auto object-contain hover:scale-110 duration-300"/>
            </div>
           <p className="uppercasemax-w-[118px]  md:mx-w-auto text-[1rem] mt-4 font-bold text-center w-[208px]">
           OROCH INTENSE MT 2024 1º LUGAR EM SATISFAÇÃO DOS CLIENTES. (Fonte: Google)</p>
         <div className="mt-8 border-t w-full border-[#FFC107]"></div>
         <p className="text-[12.8px] max-w-[138px] md:mx-w-auto  text-[#222222] py-[10px] mt-8 text-center">A Renault Oroch 2023 traz mais força, mais robustez e mais conforto para seu o dia a dia. Ela vem equipada com motor turbo TCe 1.3 flex de 170 cv, multimídia flutuante de 8” com espelhamento sem fio, suspensão Multilink, caçamba com capacidade para até 680kg e amplo espaço interno para 5 ocupantes. Uma picape feita para você ir além. 
      ...
      <div className="mt-10 flex">
        <div className="h-auto w-[150px] md:w-[280px] ">
          <div className="w-full h-full rounded-md flex flex-col items-center px-2 border">
            ...
            <div className="mt-4 py-4">
              <Image src={car7} alt="car1" className="w-[108px] md:w-auto object-contain hover:scale-110 duration-300"/>
            </div>
           <p className="uppercase max-w-[118px]  md:mx-w-auto text-[1rem] mt-4 font-bold text-center w-[208px]">
      ...
      <div className="mt-10 flex items-start ">
        <div className="h-auto w-[150px] md:w-[280px] ">
          <div className="w-full h-full rounded-md flex flex-col items-center px-2 border space-y-12">
            ...
            <div className="mt-4 py-4">
              <Image src={car8} alt="car1" className="w-[108px] md:w-auto object-contain hover:scale-110 duration-300"/>
            </div>
           <p className="uppercase max-w-[118px]  md:mx-w-auto text-[1rem] mt-4 font-bold text-center w-[208px]">
           MÉGANE E-TECH 100% ELÉTRICO</p>
         <div className="mt-8 border-b w-full border-[#FFC107]"></div>
      
       <p className="text-[12.8px] max-w-[138px] md:mx-w-auto  text-[#222222] py-[10px] mt-6 mb flex items-center justify-center text-center">
