      ...
      <div className="flex justify-start flex-wrap gap-1  ">
        <div className="flex justify-center items-center flex-col gap-4 mb-4">
          <Image
            src={car5}
            alt=""
            className="object-contain max-w-[300px] hover:scale-110 duration-300 maxh-[130px]"
          />
        ...
        <div className="flex justify-center items-center flex-col gap-4 mb-4">
          <Image
            src={list2}
            alt=""
            className="object-contain hover:scale-110 duration-300 max-w-[300px] maxh-[130px]"
          />
        ...
        <div className="flex justify-center items-center flex-col gap-4 mb-4">
          <Image
            src={list9}
            alt=""
            className="object-contain max-w-[300px] maxh-[130px]"
          />
